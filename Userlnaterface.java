        ...
        while (true) {
            ...
            switch (pilihan) {
                ...
                case "R":
                    ...
                    break;
                case "U":
                    System.out.println("INFO: Anda memilih Update");
                    db.view();
                    ...
                    if (index >= 0) {
                        ...
                        if (status == true) {
                            ...
                            System.out.println("GAGAL MEMPERNAHARUI DATA");
                        }
                        System.out.println("--------------------------------");
                    }else {
